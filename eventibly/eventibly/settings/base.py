...
INSTALLED_APPS = [
    ...
    # Local apps, referenced via eventibly.appname
]
...
#AUTH_PROFILE_MODULE = 'eventibly.accounts.UserProfile'
...
WSGI_APPLICATION = 'eventibly.wsgi.application'
