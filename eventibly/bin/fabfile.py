...
env.hosts = ['eventibly.example.com']
env.code_dir = '/srv/www/eventibly'
env.virtualenv = '/srv/www/eventibly/.virtualenv'
env.code_repo = 'git@github.com:user/eventibly.git'
env.django_settings_module = 'eventibly.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/eventibly/wsgi.py" % env.code_dir)
